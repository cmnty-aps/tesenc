...
// Register system fonts under the 'Arial' alias for Linux/Railway support
try {
  const regularPath = "/usr/share/fonts/truetype/liberation/LiberationSans-Regular.ttf";
  const boldPath = "/usr/share/fonts/truetype/liberation/LiberationSans-Bold.ttf";
  ...
  console.error("[CANVAS_FONT] Failed to register system font Arial:", err);
}
